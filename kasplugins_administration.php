 ...
 **/
	...
	function kasplugins_wp_admin_home() {
		// Generate plugin URL	
		$url = defined('WP_PLUGIN_URL') ? WP_PLUGIN_URL . '/wp-kaslatex' : get_bloginfo('wpurl') . '/wp-content/plugins/wp-kaslatex';
		echo '<div class="wrap">';
	...
	function kasplugins_wp_addmenu() {
		if ( function_exists('add_menu_page') ) {
			// Main menu
			add_menu_page( 'Settings', 'KasPlugins', 8, __FILE__, 'kasplugins_wp_admin_home',plugins_url('wp-kaslatex/kas-16.png'));
		}
	}
	if (is_admin()) {
